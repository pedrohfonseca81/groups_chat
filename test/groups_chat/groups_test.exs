defmodule GroupsChat.GroupsTest do
  ...
  describe "groups" do
    ...
    @valid_attrs %{key: "7488a646-e31f-11e4-aace-600308960662", name: "some name"}
    @update_attrs %{key: "7488a646-e31f-11e4-aace-600308960668", name: "some updated name"}
    ...
    test "create_group/1 with valid data creates a group" do
      ...
      assert group.key == "7488a646-e31f-11e4-aace-600308960662"
    ...
    test "update_group/2 with valid data updates the group" do
      ...
      assert group.key == "7488a646-e31f-11e4-aace-600308960668"
