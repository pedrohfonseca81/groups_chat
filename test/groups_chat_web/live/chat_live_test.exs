defmodule GroupsChatWeb.ChatLiveTest do
  ...
  @create_attrs %{body: "some body", key: "7488a646-e31f-11e4-aace-600308960662"}
  ...
  describe "Index" do
    ...
    test "lists all messages", %{conn: conn, chat: chat} do
